...
tabFGnormalFile:"#eee",tabFGnormalTab:"#888",serverQueueItems:[],previewWindow:!1,pluginIntervalRefs:[],overPopup:!1,cmdKey:!1,fmReady:!1,bugReportStatus:"off",bugReportPath:"",bugFilesSizesSeen:[],bugFilesSizesActual:[],githubDiff:!1,githubAuthTokenSet:!1,splitPane:!1,renderLineStyle:!1,renderPaneShiftAmount:0,debounce:"",editorFocusInstance:"",ready:!1,initAliases:function(){for(var a="header files fileOptions optionsFile optionsEdit optionsRemote optionsHelp filesFrame editor tabsBar findBar content footer nestValid nestDisplay splitPaneControls charDisplay byteDisplay".split(" "),
...
a.getLine(f).indexOf("{")?"brace":"xml",null,"+","-",!0,a,f)}top.ICEcoder.splitPane&&top.ICEcoder.updateDiffs();b&&top.ICEcoder.previewWindow.location&&top.ICEcoder.updatePreviewWindow(a,b,d,e);top.ICEcoder.indicateChanges()},cMonInputRead:function(a,b){"keypress"==top.ICEcoder.autoComplete&&top.ICEcoder.codeAssist&&(clearTimeout(top.ICEcoder.debounce),a.state.completionActive||(top.ICEcoder.debounce=setTimeout(function(){CodeMirror.commands.autocomplete(a)},200)))},cMonRenderLine:function(a,b,c,
d){top.ICEcoder.renderLineStyle&&a.lineInfo(c).line+1==top.ICEcoder.renderLineStyle[1]&&(d.style[top.ICEcoder.renderLineStyle[2]]=top.ICEcoder.renderLineStyle[3])},updateDiffs:function(){var a,b,c,d,e;a=top.ICEcoder.getcMInstance();b=top.ICEcoder.getcMdiffInstance();c=difflib.stringAsLines(a.getValue());d=difflib.stringAsLines(b.getValue());c=(new difflib.SequenceMatcher(c,d)).get_opcodes();e=a.getAllMarks();for(d=0;d<e.length;d++)e[d].clear();e=b.getAllMarks();for(d=0;d<e.length;d++)e[d].clear();
top.ICEcoder.renderLineStyle=!1;for(d=top.ICEcoder.renderPaneShiftAmount=0;d<c.length;d++)"equal"!==c[d][0]&&("replace"==c[d][0]&&(e=(c[d][4]-c[d][2]+1+top.ICEcoder.renderPaneShiftAmount)*a.defaultTextHeight(),0>=e&&(e=a.defaultTextHeight()),top.ICEcoder.renderLineStyle=["main",c[d][2],"height",e+"px"]),e="replace"==c[d][0]?"diffGrey":"diffGreen",a.markText({line:c[d][1],ch:0},{line:c[d][2]-1,ch:1E6},{className:e}),top.ICEcoder.renderLineStyle=!1,"replace"!=c[d][0]&&c[d][3]==c[d][4]&&(top.ICEcoder.renderLineStyle=
["diff",c[d][4],"height",(c[d][2]-c[d][1]+1)*a.defaultTextHeight()+"px"],b.markText({line:c[d][4]-1,ch:0},{line:c[d][4]-1,ch:1E6},{className:"diffNone"}),top.ICEcoder.renderLineStyle=!1),"replace"==c[d][0]&&(e=(c[d][2]-c[d][4]+1-top.ICEcoder.renderPaneShiftAmount)*a.defaultTextHeight(),0>=e&&(e=a.defaultTextHeight()),top.ICEcoder.renderLineStyle=["diff",c[d][4],"height",e+"px"]),e="replace"==c[d][0]?"diffGrey":"diffRed",b.markText({line:c[d][3],ch:0},{line:c[d][4]-1,ch:1E6},{className:e}),top.ICEcoder.renderLineStyle=
