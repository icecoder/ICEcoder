...
// ==============
	...
	tabDragMove: function() {
		...
		top.document.getElementById('tab'+top.ICEcoder.draggingTab).style.left = top.ICEcoder.tabDragMouseX >= 41
		? top.ICEcoder.tabDragMouseX <= parseInt(top.document.getElementById('newTab').style.left,10) - 150 - 18
		? top.ICEcoder.tabDragMouseX + "px" : (parseInt(top.document.getElementById('newTab').style.left,10) - 150 - 18) + "px" : "41px";
