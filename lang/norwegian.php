...
// / [ROOT LEVEL]
	...
	array(
		...
		"Your IP"			=> "Din IP:",
		"files"				=> "filer",
		"Last 10 files..."		=> "Siste 10 filer &aring;pnet:",
		"none"				=> "[none]",
	...
	array(
		...
		"Save"				=> "Lagre",
		"Save As"			=> "Lagre Som",
		"Live Preview"			=> "Live Forh&aring;ndsvisning",
		"Upload"			=> "Last opp",
		"Zip"				=> "Zip",
		"Print"				=> "Skriv ut",
...
// /LIB
	...
	array(
		...
		"Maybe public write..."		=> "Kanskje offentlige skriverettigheter trengs p&aring; denne, eller overordnede mappen?",
	...
	"get-branch" =>
	array(
		"There are no..."		=> "Det er ingen forskjeller mellom det lokale og GitHub repo. G&aring; tilbake til vanlig modus?",
	...
	array(
		"Sorry, cannot create..."	=> "Beklager, kan ikke opprette mappe p&aring;",
		"Cannot update config..."	=> "Kan ikke oppdatere konfigurasjonsfilen. Vennligst sett offentlige skriverettigheter p&aring;",
		...
		"Enter relative local..."	=> "Oppgi relative lokale stier (f.e. /server/myfiles) og absolutte GitHub stier (f.e. https://github.com/user/repo eller https://github.com/user/repo/tree/branch for grener), som per eksemplene. Med dette har du etablert kilde stier p&aring; begge steder, som et par.",
		"You can then..."		=> "Du kan deretter velge en sti par og dette blir da den nye rot stien i ICEcoder.",
		"The file manager..."		=> "Filbehandleren viser deretter et ny GitHub-ikon, som du kan klikke p&aring;, for &aring; utf&oslash;re en sjekk og vise en forskjell mellom de 2 kildene. Disse forskjellene kan da v&aelig;re forpliktene og flyttet til den eksterne stien p&aring; GitHub eller klonet til din lokale sti, for &aring; synkronisere filene dine.",
		"If you want..."		=> "Hvis du &oslash;nsker &aring; velge en annen rot sti, kan dette gj&oslash;res i skjermbildet Innstillinger."
	),

	"github" =>
	array(
		"Sorry, you do..."		=> "Beklager, det ser ikke ut til &aring; ha OpenSSL lastet inn p&aring; PHP instans, s&aring; https er ikke tilgjengelig. Dette er n&oslash;dvendig for GitHub dataoverf&oslash;ring, du kan endre php.ini innstillingene, start serveren p&aring; nytt og pr&oslash;v igjen"
	),
	...
	array(
		...
		"Range select"			=> "Velg onr&aring;de",
	...
	array(
		...
		"Open previous files"		=> "&Aring;pne forrige filer?",
	...
	array(
		...
		"To put into..."		=> "&Aring; sette inn i flerbrukermodus, &aring;pne innstillingsmenyen eller &aring;pen lib/config ___ settings.php og endre flerbruker til 'true', deretter laste siden om igjen",
	...
	"plugins-manager" =>
	array(
		"ICEcoder needs to..."		=> "ICEcoder m&aring; startes om igjen, for &aring; gj&oslash;re dette programtillegg kj&oslash;rbar. Start om igjen n&aring;?",
	...
	array(
		...
		"when finding in..."		=> "n&aring;r funnet i filer, utelukke",
		"assisting"			=> "assistere",
		"code assist"			=> "code assistent",
		"visible tabs"			=> "synlige faner",
		"locked nav"			=> "l&aring;st nav",
		...
		"indent size"			=> "innrykk st&oslash;rrelse",
		"font size"			=> "skriftst&oslash;rrelse",
		"layout"			=> "layout",
		...
		"Required to get..."		=> "N&oslash;dvendig for &aring; f&aring; forskjell, bestemme seg til din p&aring; GitHub lagret repo etc. Hvis du ikke har en, kan du bruke en:".PHP_EOL.PHP_EOL.
							...
							"Det anbefales ikke at du setter token din her midlertidig, og v&aelig;r sikrere p&aring; &aring; oppgi det, n&aring;r du blir bedt av ICEcoder, som som vil holde den i &oslash;kten sin.".PHP_EOL.PHP_EOL.
